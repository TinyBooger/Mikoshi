...
def build_user_response(user: User, db: Session) -> dict[str, Any]:
    ...
    return {
        ...
        "used_credits": credit_limits["used_credits"],
        ...
        "monthly_cap_reached": credit_limits["monthly_cap_reached"],
        "broke": credit_limits["broke"],
        "free_daily_cap_reached": credit_limits["free_daily_cap_reached"],
        "next_free_daily_reset_at": credit_limits["next_free_daily_reset_at"],
