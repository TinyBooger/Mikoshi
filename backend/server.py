...
from routes import auth, character, chat, user, search, tags, scene, persona, admin, invitation, problem_report, notification, character_assistant, error_log, audit_log, alipay, wechat_pay
