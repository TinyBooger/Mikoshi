...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const [usersRes, charsRes, tagsRes, termsRes] = await Promise.all([
        ...
        const [users, chars, tags, terms] = await Promise.all([
          usersRes.json(),
          charsRes.json(),
          tagsRes.json(),
          termsRes.json()
          ...
          <div className="card">
            ...
            <div className="card-body">
              <div className="d-flex gap-2 flex-wrap">
                ...
                <a href="/admin/content" className="btn btn-outline-success">
