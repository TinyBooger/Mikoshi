...
const MODEL_CONFIGS = [
  // Qwen Character
  { id: "qwen-plus-character", maxOutputTokens: 4_000,  contextLength: 32_000,    multiplier: 1.0 },
  { id: "qwen-flash-character",maxOutputTokens: 4_000,  contextLength: 8_000,     multiplier: 0.3 },

  // DeepSeek
  { id: "deepseek-v4-pro",    maxOutputTokens: 384_000, contextLength: 1_000_000, multiplier: 5.6 },
  { id: "deepseek-v4-flash",  maxOutputTokens: 384_000, contextLength: 1_000_000, multiplier: 1.9 },

  // Qwen
  { id: "qwen3.7-plus",        maxOutputTokens: 64_000, contextLength: 1_000_000, multiplier: 2.5 },
  { id: "qwen3.7-flash",       maxOutputTokens: 128_000, contextLength: 1_000_000, multiplier: 0.25 },
